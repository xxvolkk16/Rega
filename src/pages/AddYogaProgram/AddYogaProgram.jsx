...
const AddYogaProgram = () => {
  ...
  const uploadImageToStorage = async (file) => {
    try {
      ...
      // Return the file name (to be stored in Firestore)
      return file.name;
    } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const fileName = await uploadImageToStorage(selectedImage);
      ...
      await setDoc(docRef, {
        ...
        Description: formData.Description,
        Time_up: formData.Time_up,
        Picture: fileName, // Store just the filename, not the full path
      });
